...
"https://graph.facebook.com/$fbid/members?access_token=$facebook_graphapi_access_token";
...
print("\t<UIMessages>\n");
print(
"\t\t<UIMessage MessageType=\"Inform\">Facebook GraphAPI Group to Users v$VERSION</UIMessage>\n"
);
print("\t</UIMessages>\n");
print("\t<Entities>\n");
...
from_group-to_users - "To Facebook Group Users"

=head1 VERSION

This documentation refers ""To Facebook Group Users"" Alpha v$VERSION
...
from_group-to_users.pl $maltego_selected_entity $maltego_additional_field_values
...
Returns the Facebook Users(s) of a Facebook Group in Maltego via the Facebook GraphAPI
Refer to http://developers.facebook.com/docs/reference/api/group/ for futher information.
